 ...
 * thread (by means of {@link javax.swing.SwingUtilities#invokeAndWait})
 * and may need to obtain lock on the module. Therefore, it must be ensured at
 * all times that callback methods are invoked only when module's monitor is
 * free. They may not be called from synchronized blocks or methods, as it can
 * easily lead to dead locks.
 */
public class APLModule
{
	 ...
	 * 
	 * @param inEnvironment <code>true</code> if the module is performing an action in the
	 ...
	 * multi-agent system is used to create, execute or release child 
	 * modules.
	 * 
	...
	/**
	 * Gets the parent of the current module. The parent is the module that 
	 * has created this module.
	 * 
	...
	/**
	 * Sets the parent of the current module. The parent is the module that 
	 * has created this module.
	 * 
	...
	/**
	 * Sets the environments to which has the module access.
	 * 
	 ...
	 * The consequence of this action is that the next deliberation step will be
	 *  'Apply PG-Rules'.
	 */
