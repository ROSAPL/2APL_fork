...
public class APLMAS implements MessageListener, AgentListener {
    ...
    public void attachModuleToEnvironment(APLModule module, String envName,
        ...
        try {   
          ...
          //System.out.println("Attaching module: " + module + " to env: " + envName);
            
            // for callbacks
            env.attachAgentListener(module.getLocalName(), this);
    ...
    public void detachModuleFromEnvironment(APLModule module, String envName) {
        try {
            ...
            //System.out.println("Detaching module: " + module + " from env: " + envName);
