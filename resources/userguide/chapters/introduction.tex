...
\remarktmb{can we move the example somewhere else? maybe to a separate examples (sub)-section?}
...
execution of multi-agent systems programmed in 2APL.
    ...
    \begin{figure}
        \begin{center}
            ...
            %\epsfig{figure=images/mainscreen.eps,angle=0, width=0.8\textwidth}
...
the agent.
    ...
    \begin{figure}
        \begin{center}
            \epsfig{figure=images/harry.eps,width=.8\textwidth}
...
\begin{figure}
    \begin{center}
        \epsfig{figure=images/statetracer.eps,width=.8\textwidth}
...
\begin{figure}
    \begin{center}
        \epsfig{figure=images/log.eps,width=.8\textwidth}
